    ...
    <div class=" container " style="margin: 0 10%; margin-top: 50px;background-color: white; ">
      <form action='' method='post' enctype='multipart/form-data'>
            <div  class="text-center " style="background-color:#1ec4da; height: 100px; "> 
                <h2 class="title is-size-2 " style="padding-top: 25px; color: white; text-align: center; color="black""><b>Консультация</h2>
            </div>
            <h3 class="title is-size-4 " style="padding-top: 25px; color: black; text-align: center; "><b>Перейти в чат</h3>
                ...
                <div class="columns is-gapless is-multiline is-mobile " style="margin: 0 20%; padding-top: 5vh; ">
                    ...
                    <div class="column is-narrow ">
                        <label class="label " style="margin-top: 5px; font-weight: normal ; color: black ;">Тема обращения:&nbsp;&nbsp;&nbsp;&nbsp;</label>
                    </div>
                ...
                <div class="columns is-gapless is-multiline is-mobile " style="margin: 0 20%; padding-top: 5vh; ">
                    <div class="column is-narrow ">
                        <label class="label " style=" font-weight: normal ;color: black ; ">Суть обращения:&nbsp;</label>
                     </div>
                     <div class="column is-narrow ">
                     </div>
                     <div class="column is-auto ">
